...
Легче всего будет разобраться на примерах. Самый простые требуют только предложения разделения и упорядочения:
...
* Функции агрегирования с накоплением принимают только первый параметр (вектор для агрегирования). Для управления упорядочиванием используйте `order_by()`.
